            ...
            return (
              ...
              >
                ...
                <View style={styles.optionContent}>
                  {showEnglish && (
                    <Text style={optTextStyle}>{option.textEn}</Text>
                  )}
                  {showHindi && option.textHi && (
                    <Text
                      style={[
                        styles.optionTextHindi,
                        hasAnswered && isCorrectAnswer && styles.optionTextHindiCorrect,
                      ]}
                    >
                      {option.textHi}
                    </Text>
          ...
          >
            ...
            {(!isHindi || !answerResult.explanation_hi) && (
              <View style={styles.explanationSection}>
                {isBoth && answerResult.explanation_hi && (
                  <Text style={styles.explanationLangLabel}>English:</Text>
                )}
            ...
            {(isBoth || isHindi) && !!answerResult.explanation_hi && (
              <View style={[styles.explanationSection, !isHindi && styles.explanationSectionHindi]}>
                <Text style={styles.hindiExplanationTitle}>💡 हिन्दी व्याख्या:</Text>
                <Text style={styles.hindiExplanationBody}>{answerResult.explanation_hi}</Text>
              </View>
            )}
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  hindiExplanationTitle: {
    fontSize: 12,
    fontWeight: '800',
    color: '#0f172a',
    marginBottom: 4,
  },
  hindiExplanationBody: {
    fontSize: 13,
    color: '#334155',
    lineHeight: 20,
  },
