...
const SUBJECT_METAS: Record<string, SubjectMeta> = {
  // SSC CGL Tier 1 (Prelims)
  'quantitative-aptitude': {
    icon: '📐',
    badge: 'High Scoring',
    color: '#2563eb',
    bgLight: '#eff6ff',
    tagline: 'Arithmetic, Percentage, Profit & Loss, Geometry (25 Qs)',
  },
  'reasoning': {
    icon: '🧠',
    badge: 'Speed & Logic',
    color: '#7c3aed',
    bgLight: '#f5f3ff',
    tagline: 'Analogy, Series, Syllogism & Coding-Decoding (25 Qs)',
  },
  'english': {
    icon: '📖',
    badge: 'Core Verbal',
    color: '#059669',
    bgLight: '#ecfdf5',
    tagline: 'Spotting Errors, Grammar, Vocab & Idioms (25 Qs)',
  },
  'general-awareness': {
    icon: '🌍',
    ...
    color: '#d97706',
    bgLight: '#fffbeb',
    tagline: 'Polity, Modern History, Science & Current Affairs (25 Qs)',
  },
  ...
  'ssc-t2-maths': {
    ...
    color: '#2563eb',
    bgLight: '#eff6ff',
    tagline: 'Advanced Math, Probability & Statistics (30 Qs • 90 Marks)',
  },
  'ssc-t2-reasoning': {
    icon: '🧠',
    badge: 'Tier 2 • Mod 2',
    color: '#7c3aed',
    bgLight: '#f5f3ff',
    tagline: 'High-Level Logical & Analytical Puzzles (30 Qs • 90 Marks)',
  },
  'ssc-t2-english': {
    icon: '📖',
    badge: 'Tier 2 • Mod 3',
    color: '#059669',
    bgLight: '#ecfdf5',
    tagline: 'Advanced Reading Comprehension & Vocab (45 Qs • 135 Marks)',
  },
  'ssc-t2-ga': {
    icon: '🌍',
    badge: 'Tier 2 • Mod 4',
    color: '#d97706',
    bgLight: '#fffbeb',
    tagline: 'Deep Economy, Polity, Science & Current Affairs (25 Qs • 75 Marks)',
  },
  'ssc-t2-computer': {
    icon: '💻',
    badge: 'Tier 2 • Qualifying',
    color: '#0284c7',
    bgLight: '#e0f2fe',
    tagline: 'Computer Hardware, MS Office & Internet (20 Qs • 60 Marks)',
  },

  // JPSC Prelims — Paper I (General Studies)
  'prelims-gs1-history': {
    icon: '🏛️',
    badge: 'History of India',
    color: '#b45309',
    bgLight: '#fef3c7',
    tagline: 'Ancient, Medieval & Modern Indian History (15 Qs • 30 Marks)',
  },
  'prelims-gs1-geography': {
    icon: '🗺️',
    badge: 'Geography of India',
    color: '#0284c7',
    bgLight: '#e0f2fe',
    tagline: 'General, Physical, Economic & Social Geography (10 Qs • 20 Marks)',
  },
  'prelims-gs1-polity': {
    icon: '⚖️',
    badge: 'Polity & Governance',
    color: '#6366f1',
    bgLight: '#eef2ff',
    tagline: 'Constitution, Public Admin & Panchayati Raj (10 Qs • 20 Marks)',
  },
  'prelims-gs1-economy': {
    icon: '📈',
    badge: 'Economic Dev',
    color: '#059669',
    bgLight: '#ecfdf5',
    tagline: 'Basic Economy, Sustainable Dev & Reforms (10 Qs • 20 Marks)',
  },
  'prelims-gs1-science': {
    icon: '🔬',
    badge: 'Science & Tech',
    color: '#0d9488',
    bgLight: '#f0fdfa',
    tagline: 'General Science, Agriculture Tech & ICT (15 Qs • 30 Marks)',
  },
  'prelims-gs1-jharkhand': {
    icon: '🌲',
    badge: 'Jharkhand GK (P1)',
    color: '#15803d',
    bgLight: '#dcfce7',
    tagline: 'History, Society, Culture, Heritage & Resources (10 Qs • 20 Marks)',
  },
  'prelims-gs1-current': {
    icon: '📰',
    ...
    color: '#ea580c',
    bgLight: '#ffedd5',
    tagline: 'National, International & Regional Current Events (15 Qs • 30 Marks)',
  },
  'prelims-gs1-misc': {
    icon: '🌐',
    badge: 'Miscellaneous GK',
    color: '#9333ea',
    bgLight: '#faf5ff',
    tagline: 'Human Rights, Environment, Sports, Poverty & Awards (15 Qs • 30 Marks)',
  },

  // JPSC Prelims — Paper II (Jharkhand Special)
  'prelims-gs2-history': {
    icon: '📜',
    badge: 'Jharkhand History',
    color: '#b45309',
    bgLight: '#fef3c7',
    tagline: 'Tribal Governance Systems (8 Qs • 16 Marks)',
  },
  'prelims-gs2-movement': {
    icon: '✊',
    badge: 'Movements & Heroes',
    color: '#be123c',
    bgLight: '#fff1f2',
    tagline: 'Freedom Fighters & State Formation (7 Qs • 14 Marks)',
  },
  'prelims-gs2-land-laws': {
    icon: '⚖️',
    badge: 'Land Laws',
    color: '#4338ca',
    bgLight: '#e0e7ff',
    tagline: 'CNT, SPT & Other State Acts (12 Qs • 24 Marks)',
  },
  'prelims-gs2-industries': {
    icon: '🏭',
    badge: 'Mines & Industries',
    color: '#ca8a04',
    bgLight: '#fefce8',
    tagline: 'Location and Industrial Development (5 Qs • 10 Marks)',
  },
  'prelims-gs2-schemes': {
    icon: '🤝',
    ...
    color: '#be185d',
    bgLight: '#fdf2f8',
    tagline: 'Important Schemes and Sub-schemes (5 Qs • 10 Marks)',
  },
  'prelims-gs2-env': {
    icon: '🌿',
    badge: 'Environment & Forests',
    color: '#0f766e',
    bgLight: '#ccfbf1',
    tagline: 'Forest Management & Wildlife Conservation (7 Qs • 14 Marks)',
  },
  'prelims-gs2-culture-sports': {
    icon: '🎭',
    badge: 'Culture & Sports',
    color: '#c026d3',
    bgLight: '#fae8ff',
    tagline: 'Folk Dance, Festivals, Instruments, Sports & Stadiums (6 Qs • 12 Marks)',
  },

  // JPSC Mains (Descriptive Written Papers I to VI)
  'jpsc-m-hindi-english': {
    icon: '✍️',
    badge: 'Mains Paper I',
    color: '#6366f1',
    bgLight: '#eef2ff',
    tagline: 'General Hindi & General English Qualifying Paper (100 Marks)',
  },
  'jpsc-m-language-literature': {
    icon: '📖',
    badge: 'Mains Paper II',
    color: '#8b5cf6',
    bgLight: '#f5f3ff',
    tagline: 'Tribal & Regional Language Literature Paper (150 Marks)',
  },
  'jpsc-m-social-sciences': {
    icon: '🏛️',
    badge: 'Mains Paper III',
    color: '#b45309',
    bgLight: '#fef3c7',
    tagline: 'Social Sciences: History & Geography with Jharkhand focus (200 Marks)',
  },
  'jpsc-m-constitution-polity': {
    icon: '⚖️',
    badge: 'Mains Paper IV',
    color: '#2563eb',
    bgLight: '#eff6ff',
    tagline: 'Constitution, Public Administration & Good Governance (200 Marks)',
  },
  'jpsc-m-economy-dev': {
    icon: '📊',
    badge: 'Mains Paper V',
    color: '#059669',
    bgLight: '#ecfdf5',
    tagline: 'Indian Economy, Globalization & Sustainable Development (200 Marks)',
  },
  'jpsc-m-science-tech': {
    icon: '🧪',
    badge: 'Mains Paper VI',
    color: '#0d9488',
    bgLight: '#f0fdfa',
    tagline: 'General Science, Environment & Technology Development (200 Marks)',
  },
};

const getDefaultMeta = (examName: string): SubjectMeta => ({
  icon: '📚',
  badge: 'Core Subject',
  color: '#4f46e5',
  bgLight: '#eef2ff',
...
export const SubjectsScreen: React.FC<SubjectsScreenProps> = ({ navigation }) => {
  ...
  // Stage / Paper filter tab: 'ALL' | 'PRELIMS_P1' | 'PRELIMS_P2' | 'MAINS' | 'TIER_1' | 'TIER_2'
  const [selectedStageTab, setSelectedStageTab] = useState<string>('ALL');

  // Clear ALL exam-specific state when user switches exam so stale data doesn't persist
  useEffect(() => {
  ...
  const fetchSubjects = useCallback(async () => {
    setError(null);
    try {
      const data = await subjectApi.getSubjects(examSlug);
      setSubjects(data);
    } catch (err: any) {
      setError(
        err.message ||
  ...
  const fetchMarkedQuestions = useCallback(async () => {
    try {
      const data = await mockTestApi.getMarkedQuestions(undefined, examSlug);
      setMarkedData(data);
    } catch {
  ...
  const fetchPerformanceData = useCallback(async () => {
    try {
      const [summary, rec] = await Promise.all([
        performanceApi.getPerformanceSummary(examSlug),
        performanceApi.getRecommendations(examSlug),
      ]);
      setPerfData(summary);
  ...
  const fetchRevisionData = useCallback(async () => {
    try {
      const rev = await revisionApi.getRevisionSummary(examSlug);
  ...
  const fetchStudyPlan = useCallback(async () => {
    try {
      const plan = await studyPlanApi.getTodayStudyPlan(examSlug);
      setStudyPlan(plan);
    } catch {
      // Non-critical background fetch
    }
  ...
  return (
    <View style={styles.screenRoot}>
      ...
      {/* ── EXAM-AWARE HEADER BAR ── */}
      <View style={[styles.examHeaderBar, { paddingTop: topPadding }]}>
        <View style={styles.examHeaderLeft}>
          <Text style={styles.examHeaderIcon}>{activeExam.icon}</Text>
          <View>
            <Text style={styles.examHeaderName}>{activeExam.shortName || activeExam.name}</Text>
            <Text style={styles.examHeaderTagline}>Practice</Text>
          </View>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
          <LanguageToggle variant="dark" size="small" />
          <TouchableOpacity
            style={styles.examSwitchButton}
            onPress={() => navigation.navigate('ExamSelection')}
            activeOpacity={0.8}
          >
            <Text style={styles.examSwitchButtonText}>Switch Exam</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      >
        ...
        {activeTab === 'ALL' && (
          <>
            ...
            {/* EXAM-AWARE FULL MOCK TEST HERO BANNER */}
            <TouchableOpacity
              style={styles.mockHeroCard}
              onPress={() => navigation.navigate('MockInstructions', {
                examSlug: examSlug,
                paperSlug: activeExam.defaultPaperSlug,
              })}
              activeOpacity={0.88}
            >
              <View style={styles.mockBadgeRow}>
                <View style={styles.mockOfficialBadge}>
                  <Text style={styles.mockOfficialBadgeText}>
                    {activeExam.mockBadge}
                  </Text>
                </View>
                <View style={styles.mockTimerBadge}>
                  <Text style={styles.mockTimerBadgeText}>
                    ⏱️ {activeExam.mockDuration.toUpperCase()} • {activeExam.mockMaxMarks} MARKS
                  </Text>
                </View>
              </View>

              <Text style={styles.mockHeroTitle}>
                {activeExam.mockTitle}
              </Text>
              <Text style={styles.mockHeroDesc}>
                {activeExam.mockDescription}
              </Text>

              {/* 3-Column Micro Specs */}
              <View style={styles.mockSpecsRow}>
                <View style={styles.mockSpecItem}>
                  <Text style={styles.mockSpecNumber}>{activeExam.mockTotalQuestions}</Text>
                  <Text style={styles.mockSpecLabel}>Questions</Text>
                </View>
                <View style={styles.mockSpecDivider} />
                <View style={styles.mockSpecItem}>
                  <Text style={styles.mockSpecNumber}>
                    {activeExam.mockDuration}
                  </Text>
                  <Text style={styles.mockSpecLabel}>
                    {activeExam.mockDurationLabel}
                  </Text>
                </View>
                <View style={styles.mockSpecDivider} />
                <View style={styles.mockSpecItem}>
                  <Text style={styles.mockSpecNumber}>
                    {activeExam.mockMarking}
                  </Text>
              ...
              <View style={styles.mockCtaButton}>
                <Text style={styles.mockCtaButtonText}>Take {activeExam.mockTotalQuestions}-Question Mock Test</Text>
            ...
            {perfData && perfData.totalAttempted >= 5 ? (
              ...
              <View style={styles.newProfileCard}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    const examScopedSubs = subjects.filter((s) => {
                      const sExamSlug =
                        typeof s.examId === 'object' && s.examId !== null
                          ? s.examId.slug
                          : undefined;
                      if (sExamSlug) return sExamSlug.toLowerCase() === examSlug.toLowerCase();
                      return true;
                    });
                    const starterSub = examScopedSubs[0] || subjects[0];
                    if (starterSub) {
                      navigation.navigate('Topics', {
            ...
            {/* ======================================================== */}
            {/* 📚 EXAM-SPECIFIC SYLLABUS, STAGES & SUBJECT DRILLS        */}
            {/* ======================================================== */}
            {(() => {
              // 1. Client-side absolute isolation safety filter
              const examSubjects = subjects.filter((s) => {
                const sExamSlug =
                  typeof s.examId === 'object' && s.examId !== null
                    ...
                    : undefined;
                if (sExamSlug) {
                  return sExamSlug.toLowerCase() === examSlug.toLowerCase();
                }
                return true;
              });

              // 2. Generic helper to determine stage category for a subject
              const getSubjectStageKey = (s: Subject): string => {
                const stageSlug = typeof s.stageId === 'object' && s.stageId ? s.stageId.slug : '';
                const matchedStage = activeExam.stages.find(st => st.stageSlug === stageSlug);
                if (matchedStage) return matchedStage.key;
                // Fallback: use slug prefix matching for legacy data
                for (const stage of activeExam.stages) {
                  if (s.slug.startsWith(stage.stageSlug.replace(/-/g, '-'))) return stage.key;
                }
                return activeExam.stages[0]?.key || 'UNKNOWN';
              };
              ...
              const renderSubjectCard = (subject: Subject, index: number) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    {/* Top Row: Icon + Exam Badge + Stage Pill + Meta Pill */}
                    <View style={styles.subjectTopRow}>
                      <View style={[styles.iconCircle, { backgroundColor: meta.bgLight }]}>
                        <Text style={styles.subjectEmoji}>{meta.icon}</Text>
                      </View>

                      <View style={styles.subjectBadgesWrap}>
                        {/* 1. EXAM NAME BADGE */}
                        <View
                          style={[
                            styles.subjectExamBadge,
                            { backgroundColor: activeExam.bgLight, borderColor: activeExam.color + '60' },
                          ]}
                        >
                          <Text
                            style={[
                              styles.subjectExamBadgeText,
                              { color: activeExam.color },
                            ]}
                          >
                        ...
                        {/* 3. METADATA PILL */}
                        <View style={[styles.subjectMetaBadge, { backgroundColor: meta.bgLight }]}>
                          <Text style={[styles.subjectMetaBadgeText, { color: meta.color }]}>
                            {meta.badge}
                          </Text>
                        </View>
                      </View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 2 }}>
                      <Text style={[styles.subjectName, { flex: 1, marginRight: 8, marginBottom: 0 }]}>{subject.name}</Text>
                      {subject.totalQuestions !== undefined && (
                        <View style={{ backgroundColor: meta.bgLight, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, borderWidth: 1, borderColor: meta.color + '40' }}>
                          <Text style={{ fontSize: 12, color: meta.color, fontWeight: '700' }}>{subject.totalQuestions} Qs</Text>
                        </View>
                      )}
                    </View>
                    
                    <Text style={[styles.subjectTagline, { color: meta.color, fontWeight: '600', marginBottom: 2 }]}>
                      {subject.questionCountSpecifiedByPDF ? `${subject.questionCount} Target Qs` : (subject.totalQuestions ? `${subject.totalQuestions} Target Qs` : 'Target Qs Not Spec.')}
                      {' • '}
                      {subject.marksSpecifiedByPDF ? `${subject.marks} Marks` : 'Marks Not Spec.'}
                    </Text>
              ...
              // 5. Build section groupings according to stage filter
              ...
              for (const stageConfig of activeExam.stages) {
                ...
                const stageSubs = examSubjects.filter(s => getSubjectStageKey(s) === stageConfig.key);
                if (stageSubs.length === 0) continue;

                // Group by paperId for exams with multiple papers per stage
                const paperGroups = new Map<string, { title: string; subjects: Subject[] }>();
                for (const s of stageSubs) {
                  const paperSlug = typeof s.paperId === 'object' && s.paperId ? s.paperId.slug : '__default__';
                  const paperName = typeof s.paperId === 'object' && s.paperId ? s.paperId.name : stageConfig.label.replace(/^[^\w]*\s*/, '');
                  if (!paperGroups.has(paperSlug)) {
                    paperGroups.set(paperSlug, { title: paperName, subjects: [] });
                  }
                  paperGroups.get(paperSlug)!.subjects.push(s);
                }
              ...
              return (
                <View style={styles.multiExamSectionContainer}>
                  {/* SECTION HEADER: TOPIC DRILLS */}
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={styles.sectionTitle}>
                        {activeExam.syllabusTitle}
                      </Text>
                      <Text style={styles.sectionSubtitle}>
                        {activeExam.syllabusSubtitle}
                      </Text>
                    </View>
                    <View style={styles.subjectCountBadge}>
                      <Text style={styles.subjectCountText}>
                        {examSubjects.length} Available
                      </Text>
                    </View>
                  </View>

                  {/* STAGE FILTER TABS (PRELIMS / MAINS TABS) */}
                  <ScrollView
                    horizontal
                  ...
                  >
                    <TouchableOpacity
                      style={[
                        ...
                        selectedStageTab === 'ALL' && styles.stageFilterPillActive,
                      ]}
                      onPress={() => setSelectedStageTab('ALL')}
                      activeOpacity={0.8}
                    >
                      <Text
                        style={[
                          styles.stageFilterPillText,
                          selectedStageTab === 'ALL' && styles.stageFilterPillTextActive,
                        ]}
                      >
                    ...
                    {activeExam.stages.map((stageConfig) => {
                      const stageCount = examSubjects.filter(s => {
                        const st = typeof s.stageId === 'object' && s.stageId ? s.stageId.slug : '';
                        return st === stageConfig.stageSlug;
                      }).length;
                      return (
                        <TouchableOpacity
                          key={stageConfig.key}
                          style={[
                            styles.stageFilterPill,
                            selectedStageTab === stageConfig.key && styles.stageFilterPillActive,
                          ]}
                          onPress={() => setSelectedStageTab(stageConfig.key)}
                          activeOpacity={0.8}
                        >
                          <Text
                            style={[
                              styles.stageFilterPillText,
                              selectedStageTab === stageConfig.key && styles.stageFilterPillTextActive,
                            ]}
                          >
                            {stageConfig.label} ({stageCount})
                          </Text>
                        </TouchableOpacity>
                      );
                    })}
            ...
            {markedCount > 0 ? (
              <View style={styles.cardsList}>
                {markedQuestionsList.map((q, idx) => {
                  const meta = SUBJECT_METAS[q.subjectSlug] || getDefaultMeta(activeExam.name);
                  return (
            ...
            <View style={styles.modalContent}>
              ...
              <ScrollView showsVerticalScrollIndicator={false} style={styles.modalScroll}>
                <Text style={styles.modalQuestionText}>
                  {isHindi && selectedMarkedQuestion.question.questionText_hi
                    ? selectedMarkedQuestion.question.questionText_hi
                ...
                <View style={styles.modalOptionsContainer}>
                  {(['A', 'B', 'C', 'D'] as const).map((opt) => {
                    const optKeyHi = `option${opt}_hi` as keyof MockReviewQuestion;
                    const optKeyEn = `option${opt}` as keyof MockReviewQuestion;
                    const optText =
                      isHindi && selectedMarkedQuestion.question[optKeyHi]
                        ? (selectedMarkedQuestion.question[optKeyHi] as string)
                        : (selectedMarkedQuestion.question[optKeyEn] as string);
                ...
                <View style={styles.explanationBox}>
                  ...
                  <Text style={styles.explanationBoxText}>
                    {isHindi && selectedMarkedQuestion.question.explanation_hi
                      ? selectedMarkedQuestion.question.explanation_hi
...
const styles = StyleSheet.create({
  ...
  /* STAGE FILTER AND GROUPING STYLES */
  multiExamSectionContainer: {
    marginBottom: 20,
  },
  stageFilterScroll: {
    flexDirection: 'row',
  ...
  stageFilterPillTextActive: {
    color: '#ffffff',
  },
  stageSectionGroup: {
    marginBottom: 16,
  },
  stageGroupHeaderCard: {
    backgroundColor: '#ffffff',
    borderRadius: 14,
    padding: 14,
    marginBottom: 12,
