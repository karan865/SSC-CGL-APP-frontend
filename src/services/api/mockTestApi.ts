...
export const mockTestApi = {
  /**
   * Starts an official SSC CGL Tier-1 Mock Test with 100 questions.
   * Calls: POST /api/mock-tests/start
   */
  startMockTest: async (testType: 'TIER_1' = 'TIER_1'): Promise<MockStartResponse> => {
    return apiClient.post<MockStartResponse>('/mock-tests/start', { testType });
  },
   ...
   */
  getMarkedQuestions: async (sessionId?: string): Promise<MockMarkedQuestionsResponse> => {
    const params = [
